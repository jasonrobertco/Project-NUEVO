...
def configure_robot(robot: Robot) -> None:
    ...
    robot.set_odometry_parameters(
        wheel_diameter=Robot.WHEEL_DIAMETER_MM,
        wheel_base=Robot.WHEEL_BASE_MM,
        initial_theta_deg=Robot.INITIAL_THETA_DEG,
        left_motor_id=Robot.DEFAULT_LEFT_WHEEL_MOTOR,
        left_motor_dir_inverted=Robot.DEFAULT_LEFT_WHEEL_DIR_INVERTED,
        right_motor_id=Robot.DEFAULT_RIGHT_WHEEL_MOTOR,
        right_motor_dir_inverted=Robot.DEFAULT_RIGHT_WHEEL_DIR_INVERTED,
    )
